...
*feeding rates can be estimated from tagging (lunges, buzzes), prey energy from active acoustics (rorquals) or the size of squid beaks and fish otoliths (?) in stomach contents (odontocetes)*
