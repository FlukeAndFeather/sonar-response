...
Across body sizes, $P_{out}$ increased steeply with flight speed until an inflection point at approximately 1.8 m/s (Fig. \ref{Pout_fig}). 
...
```{r Pout_fig, fig.cap = "Flight power ($P_{out}$) by flight speed for \\textit{B. musculus} (blue) and \\textit{Z. cavistrostris} (red). \\label{Pout_fig}"}
