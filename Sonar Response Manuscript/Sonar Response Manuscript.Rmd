...
The rate of energy intake is the product of feeding rate ($r_f$) and prey energy per feeding event ($E_p$). $r_f$ was calculated as the lunge rate for rorquals and buzz rate for odontocetes using tag sensors. $E_p$ was derived using active acoustics (rorquals) and stomach contents (odontocetes) [ref?].
